...
\subsection{Решение ТГВ для идеальной жидкой самогравитирующей сферы}
    ...
    \begin{align*}
        \fdv{(\mathcal{L}\sqrt{-g})}{B} = 0 \quad\Longrightarrow\quad&
            r \epsilon - \frac{2}{r} - \frac{r c_0}{U^2} + \frac{2 B^2 U}{r} + 2 B^2 U' = 0 \\
        \fdv{(\mathcal{L}\sqrt{-g})}{U} = 0 \quad\Longrightarrow\quad&
            \frac{r c_0}{B U^3} + B' = 0
    \end{align*}
    ...
    %
    \begin{align*}
        m'(r) &= \frac{r^2 \epsilon}{2} + \frac{3 r^4 c_0}{2 w(r)} , \\
        w'(r) &= \frac{r^4 c_0 + (2 - r^2 \epsilon) w(r)}{r - m(r)} .
    \end{align*}
    %
    Для ультрарелятивистского газа ($\epsilon = 0$) они существенно упрощаются:
    %
    \begin{align*}
        m'(r) &= \frac{3 r^4 c_0}{2 w(r)} , \\
        w'(r) &= \frac{r^4 c_0 + 2 w(r)}{r - m(r)} .
    \end{align*}
